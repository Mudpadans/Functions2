...
// CODE HERE
const obviousStater = (param1, param2) => `The first parameter is ${param1}. The second parameter is ${param2}.`
//console.log(obviousStater('one', 'two'));
...
/*greeting('Jonathan', 'Phillips', (fullName) => {
...
// CODE HERE
const pricesPlusTax = function(array, cb) {
    array.forEach(element => {
        let tax = element + (element / 5);
        totalCost.push(tax);
    });
    cb(totalCost);
}
...
// CODE HERE
/*pricesPlusTax(prices, (fullCost) => {
    console.log(`The new array plus tax = ${fullCost}`)
});
